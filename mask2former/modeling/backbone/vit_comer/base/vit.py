...
class TIMMVisionTransformer(nn.Module):
    ...
    def __init__(self, cfg):
        ...
        in_chans = cfg.MODEL.DINOV2.IN_CHANS
        residual_indices = []
        ...
        drop_rate = 0.
        attn_drop_rate = 0.
        drop_path_rate = cfg.MODEL.DINOV2.DROP_PATH_RATE
        layer_scale = True
        embed_layer = PatchEmbed
        norm_layer = partial(nn.LayerNorm, eps=1e-6)
        act_layer = nn.GELU
        # window_attn = cfg.MODEL.DINOV2.WINDOW_ATTN
    ...
    def init_weights(self, cfg):
        DetectionCheckpointer(self, save_dir=cfg.OUTPUT_DIR).resume_or_load(
            cfg.MODEL.DINOV2.PRETRAINED, resume=False
        )
